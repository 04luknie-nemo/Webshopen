...
export const ProductSchema = z.object({
  title: z
    ...
    .max(50, { error: "Titeln får inte vara längre än 50 tecken" }),
  description: z
    .string({ error: "Beskrivningen måste vara en sträng" })
    .min(10, { error: "Beskrivningen får inte vara kortare än 10 tecken" })
    .max(300, { error: "Beskrivningen får inte vara längre än 300 tecken" }),
  price: z.coerce
  ...
  imageUrl: z
    ...
    .startsWith("https://", {
      error: "Bild url:en måste starta med: https://",
    }),
  stock: z.coerce
